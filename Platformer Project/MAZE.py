...
cyborg_image = pygame.image.load("../cristmas game project/images/cyborg.png").convert_alpha()
cyborg_image = pygame.transform.scale(cyborg_image, size)
pygame.display.set_icon(cyborg_image)

background = pygame.image.load("../cristmas game project/images/background.jpg").convert_alpha()
...
player_image = pygame.image.load("../cristmas game project/images/hero.png").convert_alpha()
player_image = pygame.transform.scale(player_image, size)
player = Player(player_image, 300, 300)
cyborg = Enemy(cyborg_image, 700, 550)


treasure = pygame.image.load("../cristmas game project/images/treasure.png").convert_alpha()
...
def game_over(text):
    rendered_text = font.render(text, True, (255, 40, 40))
